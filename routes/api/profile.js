...
//@dsec Create or update user profile
//@access Private
router.post(
  '/',
  [
...
//@dsec Get user repos from Github
//@access Public
  ...
  try {
    ...
    request(options, (error, response, body) => {
      ...
      if (response.statusCode !== 200) {
        return res.status(404).json({ msg: 'No github profilre found' })
      }
